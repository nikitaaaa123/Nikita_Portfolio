        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div 
            ...
            className={`lg:col-span-7 rounded-2xl border p-6 sm:p-8 flex flex-col justify-between transition-all duration-300 hover:shadow-2xl ${
              isDark 
                ? 'bg-[#0e1420]/80 border-slate-800/90 hover:border-slate-700/80 shadow-xl shadow-black/20' 
            ...
            <div className="space-y-5">
              ...
              <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className={`p-4 rounded-xl border transition-all duration-300 ${
                  ...
                  isDark ? 'bg-slate-900/60 border-slate-800 hover:border-violet-500/40' : 'bg-slate-50 border-slate-200 hover:border-violet-300'
                }`}>
                ...
                <div className={`p-4 rounded-xl border transition-all duration-300 ${
                  ...
                  isDark ? 'bg-slate-900/60 border-slate-800 hover:border-emerald-500/40' : 'bg-slate-50 border-slate-200 hover:border-emerald-300'
                }`}>
                  <div className={`flex items-center gap-2 text-sm font-semibold mb-1 ${
          ...
          >
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-xs px-2.5 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 font-semibold animate-pulse">
                  ...
                  {PERSONAL_INFO.education.coursework.map((course, idx) => (
                    <motion.span 
                      ...
                      className={`text-[11px] font-mono px-2 py-0.5 rounded border transition-colors cursor-default ${
                        isDark 
                          ? 'bg-slate-900/80 border-slate-800 text-slate-300 hover:border-blue-500/50 hover:text-blue-300' 
